...
EID.descriptions[languageCode].collectibles={
	{"1", "Ceapa Tristă", "↑ {{Tears}} +0.7 Lacrimi"},
	{"2", "Ochiul Interior", "Lovitură Triplă#↓ {{Tears}} Lacrimi"},
	{"3", "Îndoitor de Lingură", "Lacrimi urmăritoare"},
	{"4", "Capul lui Cricket", "↑ {{Damage}} +0.5 Vătămare#↑ {{Damage}} +50% Multiplicator Vătămare"},
	{"5", "Reflexia Mea", "Dă lacrimilor un efect de bumerang#↑ {{Range}} +1.5 Distanță#↑ {{Shotspeed}} +0.6 Viteză de Lovire#↑ +1 Înălțime Lacrimi"},
	{"6", "Numărul Unu", "↑ {{Tears}} +1.5 Lacrimi#↓ {{Range}} -17.62 Distanță#↑ +0.76 Înălțime Lacrimi"},
	{"7", "Sângele Martirului", "↑ {{Damage}} +1 Vătămare#{{Collectible34}} +50% Vătămare dacă ai Cartea lui Belial sau efectul Cărții Diavolului activ"},
	{"8", "Fratele Bobby", "Familiar cu lacrimi normale#Dă 3.5 vătămare per lacrimă"},
	{"9", "Scatol", "Toți inamicii muște devin prietenoși"},
	{"10", "Aură de Muște", "+2 orbitali muște#Blochează proiectile inamice"},
	{"11", "1up!", "↑ +1 Viață#Reînvie cu viață întreagă"},
	{"12", "Ciupercă Magică", "↑ +1 Container inimă#{{Heart}} Viață întreagă#↑ {{Damage}} +0.3 Vătămare#↑ {{Damage}} +50% Multiplicator Vătămare#↑ {{Range}} +5.25 Distanță#↑ {{Speed}} +0.3 Viteză#↑ +0.5 Mărime Lacrimi#Crește Mărimea"},
	{"13", "Virusul", "{{Poison}} Atingere de otravă#↓ {{Speed}} -0.1 Viteză#{{BlackHeart}} inamicii pot lăsa Inimi Negre dacă sunt otrăviți"},
	{"14", "Violență Necontrolată", "↑ {{Speed}} +0.6 Viteză#↑ {{Range}} +5.25 Distanță#↑ +0.5 Înălțime Lacrimi"},
	{"15", "<3", "↑ {{Heart}} +1 Container inimă#{{Heart}} Viață întreagă"},
	{"16", "Ficat Crud", "↑ {{Heart}} +2 Containere inimă#{{Heart}} Viață întreagă"},
	{"17", "Cheie Schelet", "{{Key}} +99 Chei"},
	{"18", "Un Dollar", "{{Coin}} +99 Bani"},
	{"19", "Bum!", "{{Bomb}} +10 Bombe"},
	{"20", "Transcendență", "Zbor!"},
	{"21", "Busola", "Afișează iconițele de pe hartă#Nu afișează structura hărții"},
	{"22", "Prânz", "↑ {{Heart}} +1 Container inimă"},
	{"23", "Cină", "↑ {{Heart}} +1 Container inimă"},
	{"24", "Desert", "↑ {{Heart}} +1 Container inimă"},
	{"25", "Mic Dejun", "↑ {{Heart}} +1 Container inimă"},
	{"26", "Carne Putrezită", "↑ {{Heart}} +1 Container inimă"},
	{"27", "Lingură de Lemn", "↑ {{Speed}} +0.3 Viteză"},
	{"28", "Cureaua", "↑ {{Speed}} +0.3 Viteză"},
	{"29", "Chiloții Mamei", "↑ {{Range}} +5.25 Distanță#↑ +0.5 Înălțime Lacrimi"},
	{"30", "Pantofii Mamei", "↑ {{Range}} +5.25 Distanță#↑ +0.5 Înălțime Lacrimi"},
	{"31", "Rujul Mamei", "↑ {{Range}} +5.25 Distanță#↑ +0.5 Înălțime Lacrimi"},
	{"32", "Umeraș de Sârmă", "↑ {{Tears}} +0.7 Lacrimi"},
	{"33", "Biblia", "Zbor pentru camera curentă#{{MomsHeart}} Omoară Piciorul Mamei și Inima Mamei instantaneu#!!! TE omoară când este folosită împotriva Satanei"},
	{"34", "Carte lui Belial", "↑ {{Damage}} +2 Vătămare#{{Collectible7}} +50% Vătămare dacă ai Sângele Martirului#{{AngelDevilChance}} +12.5% șansă pentru Camera Diavolului/Îngerilor cât timp este ținut"},
	{"35", "Necronomiconul", "Dă 40 vătămare tuturor inamicilor din cameră"},
	{"36", "Rahatul", "Crează un rahat și impinge înapoi inamicii#Poate fi plasat lângă o groapă și distrus cu o bombă pentru a face un pod"},
	{"37", "Dl. Bum", "Pleasează o bombă mare sub jucător ce dă 110 vătămare"},
	{"38", "Capul lui Tammy", "Împorașcă 10 lacrimi în jurul lui Isac"},
	{"39", "Sutienul Mamei", "Îngheață toți inmicii din cameră pentru 4 secunde"},
	{"40", "Kamikaze!", "Cauzează o explozie la locația jucătorului#Dă 40 vătămare"},
	{"41", "Tamponul Mamei", "{{Fear}} Sperie toți inamicii din cameră pentru 5 secunde"},
	{"42", "Capul Putrezit al lui Bob", "{{Poison}} Bombă otrăvitoare aruncabilă"},
	{"43", "", "<item does not exist>"},
	{"44", "Teleportare!", "Îl teleportează pe Isac intr-o cameră aleatorie în afară de camerele I AM ERROR"},
	{"45", "Inimă Iam", "Regenerează 1 Inimă Roșie"},
	{"46", "Picior Norocos", "↑ {{Luck}} +1 Noroc#+8%șansă de câștiga o recompensă la finalul unei camere#Șansă mai mare de a câștiga la jocuri de noroc"},
	{"47", "Telecomanda Doctorului", "{{Collectible168}} La folosire, urmărește o țintă#O rachetă cade pe țintă după 1.5 secunde#Dă de 20 de ori vătămarea ta"},
	{"48", "Săgeata Cupidonului", "Lacrimi pătrunzătoare"},
	{"49", "Shoop da Whoop!", "Laser de Leviatan de vătămare mare"},
	{"50", "Steven", "↑ {{Damage}} +1 Vătămare"},
	{"51", "Pentagramă", "↑ {{Damage}} +1 Vătămare#{{AngelDevilChance}} +10% șansă pentru Camera Diavolului/Îngerilor"},
	{"52", "Dr. Fetus", "{{Bomb}} Lacrimi bombe#Fiecare bombă dă de 5x vătămarea ta + 30#↓ {{Tears}} Întarziere Lacrimi x 2.5"},
	{"53", "Magnet", "Atracție magnetică pentru pickup-uri"},
	{"54", "Harta Comorii", "Afișează structura etajului#Nu afișează iconițele camerelor"},
	{"55", "Ochiul Mamei, "50% șansă de a împușca lacrimi la spate#{{Luck}} 100% șansă la 2 Noroc"},
	{"56", "Accident cu Lămâi", "Crează o baltă de limonadă#Dă 24 vătămare la contact pe secundă"},
	{"57", "Admirație Distantă", "Orbital muscă de distanță medie#Dă 75 vătămare la contact pe secundă"},
	{"58", "Cartea Umbrelor", "Invincibilitate pentru 10 secunde"},
	{"59", "", "<item does not exist>"},
	{"60", "Scara", "Mergi peste gropi mici"},
	{"61", "", "<item does not exist>"},
	{"62", "Farmecul Vampirului", "{{HalfHeart}} Regenerează jumătate de inimă la fiecare 13 inamici omorâți"},
	{"63", "Bateria", "Obiectele active pot fi încărcate de 2 ori"},
	{"64", "Reducere Steam", "{{Shop}} -50% la obiectele din Magazin#dacă iei acest obiect de 2 ori la rând, totul va fi gratis"},
	{"65", "Carte de Bucate Anarhistă", "Crează 6 bombe trol aproape de centrul camerei"},
	{"66", "Clepsidra", "{{Slow}} Încetinește inamicii pentru 8 secunde"},
	{"67", "Sora Maggy", "Familiar cu lacrimi normale#Dă 3.5 vătămare per lacrimă"},
	{"68", "Tehnologie", "Lacrimile sunt acum lasere"},
	{"69", "Lapte cu Ciocolată", "{{Chargeable}} Lacrimi încărcabile#↑ {{Damage}} Până la 400% Vătămare#↓ {{Tears}} Lacrimi"},
	{"70", "Hormoni de Creștere", "↑ {{Damage}} +1 Vătămare#↑ {{Speed}} +0.4 Viteză"},
	{"71", "Mini Ciupercă", "↑ {{Speed}} +0.3 Viteză#↓ {{Range}} -4.25 distanță*#↑ +1.5 Înălțime Lacrimi*#(*ambele dau o Distanță mai mare)#↑ Mărime mai mică"},
	{"72", "Rozariu", "{{SoulHeart}} +3 Inimi Suflet#{{Collectible33}} Biblia este adăugată în toate grupurile de obiecte"},
	{"73", "Cube de Carne", "LVL1: Orbital#LVL2: Orbital împușcător#LVL3: Meat Boy LVL1#LVL4: Meat Boy LVL2"},
	{"74", "25 de Cenți", "{{Coin}} +25 bani"},
	{"75", "Doctorat", "{{Pill}} Pilule mai bune#Crează o pilulă când îl iei#{{Heart}} Regenerează 2 Inimi Roșii#{{BloodDonationMachine}} Mai mulți bani de la Mașiniile de Donat Sânge și {{Collectible135}} Punga IV"},
	{"76", "Vedere cu Raze X", "{{SecretRoom}} Descoperă intrările la camerele secrete"},
	{"77", "Micul Meu Unicorn", "Invincibilitate și +0.28 Viteză pentru 6 secunde#Dă 40 vătămare la contact pe secundă cât timp ești invincibil"},
	{"78", "Cartea Revelațiilor", "{{SoulHeart}} +1 Inimă Suflet#Șansă mai mare de a întâlni Călăreții ca șefi#{{AngelDevilChance}} +17.5% șansă pentru Camera Diavolului/Îngerilor cât timp este ținută"},
	{"79", "Semnul", "↑ {{Damage}} +1 Vătămare#↑ {{Speed}} +0.2 Viteză#{{SoulHeart}} +1 Inimă Suflet"},
	{"80", "Pactul", "↑ {{Damage}} +0.5 Vătămare#↑ {{Tears}} +0.7 Lacrimi#{{SoulHeart}} +2 Inimi Suflet"},
	...
	{"215", "Goat Head", "{{AngelDevilChance}} 100% chance for Devil/Angel Rooms to spawn"},
	...
	{"257", "Fire Mind", "{{Burning}} Tears light enemies on fire#Chance for tears to explode on enemy impact#{{Luck}} 100% chance to explode at 13 Luck#!!! The explosion can hurt you!"},
	...
	{"303", "Virgo", "Chance to get invincibility when hit#{{Pill}} Converts negative pills into positive ones#{{Luck}} 100% chance at 10 Luck"},
	...
	{"374", "Holy Light", "10% chance to shoot Holy tears, which will spawn a beam of light on hit#The beam deals 4x your damage#{{Luck}} 50% chance at 9 Luck"},
	...
	{"447", "Linger Bean", "While firing without pause, spawns a poop cloud every 7.5 seconds#The cloud deals your damage 5 times a second#Cloud lasts 15 seconds#Can be moved by shooting it"},
	...
	{"496", "Euthanasia", "3.33% chance to shoot needles#{{Luck}} 100% chance at 15 Luck#Needles kill normal enemies instantly, bursting them into 10 tears#Needles deal 3x damage against bosses"},
